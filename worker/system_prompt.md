...
> "Sounds like a break in the buried line feeding that zone. Our pipe break repair runs ${{pipe_break_3ft}} — that covers up to 3 ft of 1-inch pipe with the clamps and fittings — plus the ${{service_call}} service call, so about $215 all in. And since you came in through the AI intake, if my read matches what we find on-site your first hour of repair labour is free. Want me to get a tech out?"
